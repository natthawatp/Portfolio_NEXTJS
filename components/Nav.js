...
const Nav = () => {
  ...
  return (
    ...
    >
      ...
      xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] backdrop-blur-sm 
      xl:h-max py-8 bg-white/10 text-3xl xl:text-xl xl:rounded-full"
      >
            ...
            >
              ...
              <div className="absolute pr-14 right-0 hidden xl:group-hover:flex">
                ...
                >
                  ...
                  {/* triaangle */}
                  <div className="border-solid border-l-white 
                  border-l-8 border-y-transparent border-y-[6px] border-r-0 absolute -right-2"></div>
                </div>
              </div>
